...
public class FeedForwardNetwork implements FeedForward {
    ...
    public FeedForwardNetwork(int d_model, int d_hidden, Activation act, Initializer wInit, boolean isTrainable, double dropProb) {
        this(d_model, d_hidden, act, wInit, null, isTrainable, dropProb);
    }
